...
-- @param colors color (theme) color table created by require("carmona.colors").setup()
-- @param config config options (optional)
function M.setup(colors, config)
    config = vim.tbl_extend("force", require("carmona").config, config or {})
    ...
    local hlgroups = {
        ...
        CursorLineNr                      = { fg = colors.sp, bg = "NONE", style = "bold" },
        ...
        -- TSTypeBuiltin                  = {},
        TSVariable                        = { fg = "NONE" },
        TSVariableBuiltin                 = { fg = colors.sp3, style = config.variablebuiltinStyle },
