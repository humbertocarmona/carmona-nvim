...
<p align="center">
  <img src="carmona@2x.png" width="600" >
</p>
...
All the palette colors can be found [here](lua/carmona/colors.lua).

Example:

```lua
local default_colors = require("carmona.colors").setup()
...
local my_colors = {
    ...
    -- this will be accessible from require("carmona.colors").setup()
    -- AFTER calling require("carmona").setup(config)
    new_color = "teal"
}
...
require'carmona'.setup({ overrides = overrides, colors = my_colors })
vim.cmd("colorscheme carmona")
```
...
require'carmona'.setup({ globalStatus = true, ... })
vim.cmd("colorscheme carmona")
```
...
* [alacritty](extras/alacritty_carmona.yml)
* [base16](extras/base16-theme.yaml)
* [fish](extras/carmona.fish)
* [foot](extras/foot_carmona.ini)
* [iTerm](extras/carmona.itermcolors)
* [kitty](extras/carmona.conf)
...
- [carmona.vim](https://github.com/guigui64/kanawaga.vim) - unaffiliated vimscript port of carmona.nvim
